...
export const DEFAULT_PORTAL_DATA: AppData = {
  ...
  procurement: {
    ...
    apps: [
      ...
      { name: "CMG Petty Cash Management", url: "https://cmg-petty-cash-management.web.app/login", icon: "fa-money-bill-wave", color: "bg-purple-600", desc: "ระบบบริหารจัดการเงินสดย่อย" },
  ...
  hr: {
    ...
    apps: [
      ...
      { name: "Master Database CMG",   url: "https://cmg-hr-database.web.app/", icon: "fa-database",       color: "bg-slate-600",   desc: "ระบบจัดการฐานข้อมูล" },
      { name: "Work for Success",      url: "https://cnpg5q.csb.app/",    icon: "fa-trophy",         color: "bg-amber-500",   desc: "ร่วมด้วยช่วยกันเพื่อความฝันของเรา" },
      { name: "Performance Evaluation",url: "https://cmg-performance-system.web.app/", icon: "fa-chart-line",     color: "bg-green-600",   desc: "งานประเมินพนักงาน" },
    ],
  },
  safety: {
